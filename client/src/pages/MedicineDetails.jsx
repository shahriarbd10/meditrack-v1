...
export default function MedicineDetails() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-base-100 rounded-md shadow-md mt-6">
      ...
      <img src={medicine.picture} alt={medicine.name} className="w-full h-64 object-cover mb-4 rounded" />
      ...
      <div className="mt-4 flex space-x-4">
        <Link to={`/edit-medicine/${medicine._id}`} className="btn btn-primary">
          Edit Medicine
        </Link>
        <Link to="/dashboard/admin" className="btn btn-outline">
          Back to Dashboard
        </Link>
      </div>
    </div>
