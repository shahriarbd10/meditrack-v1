      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-xl overflow-hidden border border-base-300">
        ...
        <div className="px-6 md:px-8 py-6 border-b border-base-300">
          ...
          <div className="mt-2 flex flex-wrap gap-2 items-center">
            {genericName && (
              <span className="badge badge-neutral" title="Generic Name">
                {genericName}
              </span>
            )}
            {brandName && <span className="badge badge-outline">{brandName}</span>}
            <span
              className={`badge ${
            ...
            {type && <span className="badge badge-outline">{type}</span>}
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-base-300 p-4 bg-base-100 shadow-sm">
              ...
              <div className="mt-2 text-xs text-base-content/70 flex items-center justify-between">
                ...
                <span className="font-semibold">${fmtMoney(supplierPrice)}</span>
              </div>
            </div>
          </div>
        ...
        <div className="px-6 md:px-8 py-6 border-t border-base-300 flex gap-2 justify-end">
          <Link to="/" className="btn btn-outline btn-sm md:btn-md">
            Back to Home
          </Link>
          <Link
