...
export default function Sidebar() {
  ...
  const Icon = {
    ...
    pills: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 3.75A6.75 6.75 0 0115.75 10.5h0A6.75 
             6.75 0 119 3.75zm6.75 6.75..."
        />
      </svg>
    ),
    supplier: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M16.5 7.5V6a4.5 4.5 0 10-9 0v1.5M3 10.5h18
             M5.25 10.5v9.75..."
        />
      </svg>
    ),
    ...
    chevron: (open) => (
      <svg
        ...
        strokeWidth="1.5"
        stroke="currentColor"
        className={`w-4 ml-auto transition-transform ${
          open ? "rotate-180" : ""
        }`}
      >
        <path
  ...
  // Paths (add `edit` for programmatic navigation only)
  const CUSTOMER = {
